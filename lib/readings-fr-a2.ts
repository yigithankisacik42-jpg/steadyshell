...
const unit340Reading: UnitReading = {
  ...
  story: {
    ...
    translation:
      "Bugün çikolatalı mus yapıyoruz! Kolay ve lezzetli. İşte tarifi:\n\n1. Önce, çikolatayı parçalara ayırın (kırın) ve benmari usulü eritin.\n2. Sonra, yumurtaların beyazlarını ve sarılarını ayırın.\n3. Sarıları biraz şekerle karıştırın.\n4. Erimiş çikolatayı ekleyin.\n5. Beyazları kar haline gelene kadar çırpın (çok katı!).\n6. Beyazları yavaşça karışıma yedirin (ekleyin).\n7. Son olarak, 3 saat buzdolabına koyun.\n\nSaati gelmeden dokunmayın! Afiyet olsun!",
  },
  questions: [
    {
      id: 1,
      question: "Bu tarif ne için?",
      options: ["Kek", "Çorba", "Çikolatalı Mus", "Salata"],
      correctAnswer: "Çikolatalı Mus",
    },
    {
      id: 2,
      question:
        "Çikolatayı nasıl eritmelisiniz? (Comment faire fondre le chocolat?)",
      options: [
        "Mikrodalgada",
        "Benmari usulü (Au bain-marie)",
        "Tavada",
        "Fırında",
      ],
      correctAnswer: "Benmari usulü (Au bain-marie)",
    },
    {
      id: 3,
      question: "Buzdolabında ne kadar kalmalı?",
      options: ["1 saat", "30 dakika", "3 saat", "Bir gece"],
      correctAnswer: "3 saat",
    },
    {
      id: 4,
      question: "Beyazları nasıl çırpmalısınız?",
      options: ["Sıvı", "Kar gibi (En neige)", "Sıcak", "Şekerli"],
      correctAnswer: "Kar gibi (En neige)",
    },
  ],
  vocabulary: [
...
const unit341Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Sophie est allée au centre commercial. Elle a trouvé une belle robe qui était en solde. La robe coûtait 50 euros au lieu de 100. C'était une bonne affaire!",
    translation:
      "Sophie alışveriş merkezine gitti. İndirimde güzel bir elbise buldu. Elbise 100 yerine 50 euro'ydu. İyi bir fırsattı!",
  },
  questions: [
    {
      id: 1,
      question: "Elbise ne kadardı?",
      options: ["100 euro", "50 euro", "75 euro", "25 euro"],
      correctAnswer: "50 euro",
    },
  ],
  vocabulary: [{ word: "En solde", meaning: "İndirimde" }],
};
...
const unit342Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Marc cherchait un costume pour un mariage. Il a essayé plusieurs vestes. La noire lui allait très bien. Le vendeur a dit: 'Cette veste vous va à merveille!'",
    translation:
      "Marc bir düğün için takım elbise arıyordu. Birkaç ceket denedi. Siyah olan ona çok yakıştı. Satıcı dedi: 'Bu ceket size harika yakışıyor!'",
  },
  questions: [
    {
      id: 1,
      question: "Marc ne arıyordu?",
      options: ["Pantolon", "Takım elbise", "Gömlek", "Ayakkabı"],
      correctAnswer: "Takım elbise",
    },
  ],
  vocabulary: [{ word: "Essayer", meaning: "Denemek" }],
};
...
const unit343Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Samedi matin, toute la famille a fait le ménage. Papa a passé l'aspirateur. Maman a fait la lessive. Les enfants ont rangé leurs chambres. Après, la maison était propre!",
    translation:
      "Cumartesi sabahı tüm aile temizlik yaptı. Baba elektrik süpürgesi çekti. Anne çamaşır yıkadı. Çocuklar odalarını topladılar. Sonra ev tertemizdi!",
  },
  questions: [
    {
      id: 1,
      question: "Baba ne yaptı?",
      options: ["Bulaşık", "Süpürge", "Çamaşır", "Yemek"],
      correctAnswer: "Süpürge",
    },
  ],
  vocabulary: [{ word: "Le ménage", meaning: "Temizlik" }],
};
...
const unit344Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Quand j'étais jeune, je lisais le journal tous les matins. Mon père regardait les informations à la télé. Maintenant, je lis les actualités sur mon téléphone.",
    translation:
      "Gençken her sabah gazete okurdum. Babam televizyonda haberleri izlerdi. Şimdi haberleri telefonumdan okuyorum.",
  },
  questions: [
    {
      id: 1,
      question: "Şimdi haberleri nereden okuyor?",
      options: ["Gazete", "TV", "Telefon", "Radio"],
      correctAnswer: "Telefon",
    },
  ],
  vocabulary: [{ word: "Quand j'étais jeune", meaning: "Gençken" }],
};
...
const unit345Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Marie adore les séries policières. Elle regarde une série qui s'appelle 'Mystères de Paris'. C'est une émission qui passe tous les lundis. Elle ne rate jamais un épisode!",
    translation:
      "Marie polisiye dizileri çok seviyor. 'Paris Gizemleri' adında bir dizi izliyor. Her pazartesi yayınlanan bir program. Hiçbir bölümü kaçırmaz!",
  },
  questions: [
    {
      id: 1,
      question: "Dizi ne zaman yayınlanıyor?",
      options: ["Pazar", "Pazartesi", "Cuma", "Cumartesi"],
      correctAnswer: "Pazartesi",
    },
  ],
  vocabulary: [{ word: "Ne rate jamais", meaning: "Hiç kaçırmaz" }],
};
