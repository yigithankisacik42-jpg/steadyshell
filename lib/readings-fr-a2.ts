...
const unit331Reading: UnitReading = {
  ...
  questions: [
    {
      id: 1,
      question: "Kiminle tatile gitti?",
      options: ["Seul", "Avec ses parents", "Avec Thomas et Sophie"],
      correctAnswer: "Avec Thomas et Sophie",
    },
    {
      id: 2,
      question: "Nereye gittiler?",
      options: ["À Paris", "À Nice", "À Lyon"],
      correctAnswer: "À Nice",
    },
    {
      id: 3,
      question: "Yolculuk ne kadar sürdü?",
      options: ["Cinq heures", "Six heures", "Trois heures"],
      correctAnswer: "Cinq heures",
    },
    {
      id: 4,
      question: "Nerede kaldılar?",
      options: ["Dans un hôtel", "Dans un appartement", "Chez des amis"],
      correctAnswer: "Dans un appartement",
    },
    {
      id: 5,
      question: "İlk gün ne yaptılar?",
      options: [
        "Ils ont visité un musée",
        "Ils ont nagé",
        "Ils ont fait du shopping",
      ],
      correctAnswer: "Ils ont nagé",
    },
    {
      id: 6,
      question: "Akşam yemeğinde ne yedi?",
      options: ["Une pizza", "Des pâtes", "Une salade niçoise"],
      correctAnswer: "Une salade niçoise",
    },
    {
      id: 7,
      question: "İkinci gün hangi müzeyi gezdiler?",
      options: ["Le Louvre", "Le musée Matisse", "Le musée Picasso"],
      correctAnswer: "Le musée Matisse",
    },
    {
      id: 8,
      question: "Üçüncü gün neden sinemaya gittiler?",
      options: ["Il a plu", "Ils étaient fatigués", "C'était la nuit"],
      correctAnswer: "Il a plu",
    },
    {
      id: 9,
      question: "Ailesi için ne aldı?",
      options: ["Des vêtements", "De l'huile d'olive", "Du vin"],
      correctAnswer: "De l'huile d'olive",
    },
    {
      id: 10,
      question: "Eve döndüğünde nasıl hissediyordu?",
      options: ["Triste", "Fatigué mais heureux", "Malade"],
      correctAnswer: "Fatigué mais heureux",
    },
  ],
};
...
const unit332Reading: UnitReading = {
  ...
  story: {
    ...
    translation:
      "Gelecek yıl Pierre Japonya'ya seyahat edecek. Tokyo ve Kyoto'yu ziyaret edecek. İki hafta kalmayı planladı. Japon mutfağını tadacak ve tapınakları gezecek. Gitmek için sabırsızlanıyor!",
  },
  questions: [
    {
      id: 1,
      question: "Pierre nereye gidecek?",
      options: ["Çin", "Kore", "Japonya", "Vietnam"],
      correctAnswer: "Japonya",
    },
    {
      id: 2,
      question: "Ne kadar kalacak?",
      options: ["Bir hafta", "İki hafta", "Bir ay", "Üç gün"],
      correctAnswer: "İki hafta",
    },
  ],
  vocabulary: [
...
const unit333Reading: UnitReading = {
  ...
  story: {
    ...
    translation:
      "Sophie bu sabah kendini iyi hissetmiyordu. Başı ve boğazı ağrıyordu. Ateşini ölçtü: ateşi vardı! Doktora gitti. Doktor ona dedi: 'Gripsiniz. Dinlenmelisiniz. Çok su içmek ve bu ilaçları günde üç kez almak lazım.' Sophie doktorun tavsiyelerine uydu. Üç gün sonra çok daha iyiydi!",
  },
  questions: [
    {
      id: 1,
      question: "Sophie'nin nesi ağrıyordu?",
      options: [
        "Kolu ve bacağı",
        "Başı ve boğazı",
        "Dişleri ve kulağı",
      ...
      correctAnswer: "Başı ve boğazı",
    },
    {
      id: 2,
      question: "Sophie'nin hastalığı neydi?",
      options: ["Nezle", "Grip", "Alerji", "Mide ağrısı"],
      correctAnswer: "Grip",
    },
    {
      id: 3,
      question: "Doktor ne tavsiye etti?",
      options: [
        "Spor yapmak",
        "Dinlenmek ve su içmek",
        "Yemek yemek",
        "Çalışmaya devam etmek",
      ],
      correctAnswer: "Dinlenmek ve su içmek",
    },
    {
      id: 4,
      question: "İlaçları günde kaç kez alacak?",
      options: ["Bir kez", "İki kez", "Üç kez", "Dört kez"],
      correctAnswer: "Üç kez",
    },
    {
      id: 5,
      question: "Sophie ne kadar sürede iyileşti?",
      options: ["Bir gün", "İki gün", "Üç gün", "Bir hafta"],
      correctAnswer: "Üç gün",
    },
  ],
  vocabulary: [
...
const unit334Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Kimlik ve fatura",
    },
    {
      id: 3,
      question: "Kredi kartı ne zaman gelecek?",
      options: ["Hemen", "Yarın", "5 gün içinde", "Bir ay sonra"],
      correctAnswer: "5 gün içinde",
    },
  ],
  vocabulary: [
...
const unit335Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Julie voulait envoyer un colis à sa grand-mère. Elle est allée à la poste. Elle a acheté des timbres et a rempli l'adresse. Le colis arrivera dans trois jours.",
    translation:
      "Julie büyükannesine paket göndermek istiyordu. Postaneye gitti. Pul aldı ve adresi yazdı. Paket üç gün içinde varacak.",
  },
  questions: [
    {
      id: 1,
      question: "Julie ne göndermek istedi?",
      options: ["Mektup", "Paket", "Kart", "Para"],
      correctAnswer: "Paket",
    },
  ],
  vocabulary: [
    { word: "Envoyer", meaning: "Göndermek" },
    { word: "Le colis", meaning: "Paket" },
  ],
};
...
const unit336Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Thomas a réservé une chambre d'hôtel en ligne. Il a choisi une chambre double avec vue sur la mer. Le petit-déjeuner était inclus. À son arrivée, la réceptionniste lui a donné la clé de la chambre 305.",
    translation:
      "Thomas internetten otel odası rezerve etti. Deniz manzaralı çift kişilik oda seçti. Kahvaltı dahildi. Geldiğinde resepsiyonist ona 305 numaralı odanın anahtarını verdi.",
  },
  questions: [
    {
      id: 1,
      question: "Thomas ne tür oda seçti?",
      options: ["Tek kişilik", "Çift kişilik", "Aile odası", "Süit"],
      correctAnswer: "Çift kişilik",
    },
  ],
  vocabulary: [
    { word: "Réserver", meaning: "Rezerve etmek" },
    { word: "Vue sur la mer", meaning: "Deniz manzaralı" },
  ],
};

const unit337Reading: UnitReading = {
  unitId: 337,
  title: "Tren İstasyonunda Karmaşa",
  language: "Fransızca",
  level: "A2",
  story: {
...
const unit338Reading: UnitReading = {
  ...
  story: {
    ...
    translation:
      "Dün, havaalanında zor bir gündü. Büyük bir fırtına yüzünden, tüm uçuşlar iptal edildi. Pistler güvenlik nedeniyle kapatıldı. Yolcular yakındaki otellere yönlendirildi. Bagajları güvenli bir yerde depolandı, ama bazı bavullar kayboldu. Yolcular kızgındı, ama ertesi gün havayolu şirketi tarafından paraları iade edildi.",
  },
  questions: [
    {
      id: 1,
      question:
        "Uçuşlar neden iptal edildi? (Pourquoi les vols ont été annulés?)",
      options: [
        "Grev yüzünden",
        "Fırtına yüzünden",
        "Teknik arıza",
      ...
      correctAnswer: "Fırtına yüzünden",
    },
    {
      id: 2,
      question:
        "Yolcular nereye yönlendirildi? (Où ont été dirigés les passagers?)",
      options: ["Eve", "Başka bir şehre", "Otellere", "Uçağa"],
      correctAnswer: "Otellere",
    },
    {
      id: 3,
      question:
        "Yolculara ne yapıldı? (Qu'est-ce qui a été fait pour les passagers?)",
      options: [
        "Tutuklandılar",
        "Para iadesi yapıldı (Remboursés)",
        "Unutuldular",
        "Cezalandırıldılar",
      ],
      correctAnswer: "Para iadesi yapıldı (Remboursés)",
    },
  ],
  vocabulary: [
...
const unit340Reading: UnitReading = {
  ...
  questions: [
    {
      ...
      options: ["Lyon'da bir kafede", "Paris'te bir mutfakta", "Bir okulda", "Sokakta"],
      correctAnswer: "Paris'te bir mutfakta",
    },
    {
      id: 2,
      question: "Şef Pierre'in asistanının adı nedir?",
      options: ["Ali", "Thomas", "Julien", "Marc"],
      correctAnswer: "Julien",
    },
    {
      id: 3,
      question: "Şefin verdiği ilk talimat nedir?",
      options: ["Domatesleri kesmek", "Masayı kurmak", "Sebzeleri iyi yıkamak", "Sosu karıştırmak"],
      correctAnswer: "Sebzeleri iyi yıkamak",
    },
    {
      id: 4,
      question: "Şef domatesleri ve soğanları kestikten sonra ne yapmamasını söyüyor (olumsuz emir)?",
      options: ["Karıştırmamasını", "Eklememesini", "Yememesini", "Ağlamamasını"],
      correctAnswer: "Ağlamamasını",
    },
    {
      id: 5,
      question: "Sos için neler eklenmeli?",
      options: ["Sadece tuz", "Tuz ve biber", "Süt ve un", "Sadece biber"],
      correctAnswer: "Tuz ve biber",
    },
    {
      id: 6,
      question: "'Ne mélange pas trop vite' cümlesinin anlamı nedir?",
      options: ["Daha hızlı karıştır", "Karıştırmayı bırak", "Çok hızlı karıştırma", "Hemen karıştır"],
      correctAnswer: "Çok hızlı karıştırma",
    },
    {
      id: 7,
      question: "Masayı kim kuracak?",
      options: ["Şef", "Julien", "Müşteriler", "Garsonlar"],
      correctAnswer: "Garsonlar",
    },
    {
      id: 8,
  ...
  vocabulary: [
    ...
    { word: "Lentement", meaning: "Yavaşça" },
    { word: "Surtout", meaning: "Özellikle" },
    { word: "Trop vite", meaning: "Çok hızlı" },
    { word: "Appelle", meaning: "Çağır (appeler)" },
    { word: "Du poivre", meaning: "Biraz karabiber" },
  ],
};

// Kısa format devam
const unit341Reading: UnitReading = {
  unitId: 341,
  ...
  questions: [
    {
      id: 1,
      question: "Thomas kimin için hediye alıyor?",
      options: ["Kendisi için", "Erkek kardeşi için", "Babası için", "Arkadaşı için"],
      correctAnswer: "Erkek kardeşi için",
    },
    {
      id: 2,
      question: "Hangi kaban daha şık?",
      options: ["Mavi kaban", "Siyah kaban", "Kırmızı kaban", "Yeşil kaban"],
      correctAnswer: "Siyah kaban",
    },
    {
      id: 3,
      question: "Siyah kaban ne kadar?",
      options: ["90 euro", "100 euro", "120 euro", "150 euro"],
      correctAnswer: "150 euro",
    },
    {
      id: 4,
      question: "Mavi kabanın avantajı nedir?",
      options: ["Daha şık olması", "Daha pahalı olması", "Daha rahat ve sıcak olması", "Daha büyük olması"],
      correctAnswer: "Daha rahat ve sıcak olması",
    },
    {
      id: 5,
      question: "Satıcı kış için hangisinin daha iyi olduğunu söylüyor?",
      options: ["Kırmızı kaban", "Siyah kaban", "Mavi kaban", "Hiçbiri"],
      correctAnswer: "Mavi kaban",
    },
    {
      id: 6,
      question: "Metinde kırmızı kaban hakkında ne söyleniyor?",
      options: ["Çok ucuz", "Siyah kadar pahalı", "Maviden daha sıcak", "En güzel kaban"],
      correctAnswer: "Siyah kadar pahalı",
    },
    {
      id: 7,
      question: "Sonuç olarak Thomas hangisini satın alıyor?",
      options: ["Siyah kabanı", "Kırmızı kabanı", "Mavi kabanı", "Hiçbirini"],
      correctAnswer: "Mavi kabanı",
    },
    {
      id: 8,
      question: "Metindeki 'plus chaud' ne anlama gelir?",
  ...
  vocabulary: [
    ...
    { word: "Plus joli", meaning: "Daha güzel" },
    { word: "Moins élégant", meaning: "Daha az şık" },
    { word: "Aussi cher que", meaning: "Kadar pahalı" },
    { word: "Meilleur", meaning: "Daha iyi" },
    { word: "Réfléchir", meaning: "Düşünmek" },
  ],
};

const unit342Reading: UnitReading = {
  unitId: 342,
  ...
  questions: [
    {
      id: 1,
      question: "Sophie neden mağazaya gitti?",
      options: ["Kendine kıyafet almak", "Annesi için hediye", "Arkadaşıyla buluşmak", "İş görüşmesi"],
      correctAnswer: "Annesi için hediye",
    },
    {
      id: 2,
      question: "Satıcı hangi elbiseyi önerdi?",
      options: ["Mavi elbise", "Siyah elbise", "Kırmızı elbise", "Beyaz elbise"],
      correctAnswer: "Kırmızı elbise",
    },
    {
      id: 3,
      question: "Sophie neden elbiseyi almadı?",
      options: ["Çok pahalıydı", "Daha basit bir şey istiyordu", "Bedeni yoktu", "Rengi beğenmedi"],
      correctAnswer: "Daha basit bir şey istiyordu",
    },
    {
      id: 4,
      question: "Sophie hangi kıyafeti denedi?",
      options: ["Kırmızı elbise", "Beyaz gömlek", "Mavi pantolon", "Siyah ceket"],
      correctAnswer: "Beyaz gömlek",
    },
    {
      id: 5,
      question: "Sophie ek olarak ne seçti?",
      options: ["Kırmızı elbise", "Siyah pantolon", "Mavi kazak", "Ayakkabılar"],
      correctAnswer: "Mavi kazak",
    },
    {
      id: 6,
      question: "Gömlek ne kadardı?",
      options: ["25 euro", "35 euro", "45 euro", "80 euro"],
      correctAnswer: "35 euro",
    },
    {
      id: 7,
      question: "Sophie nasıl ödedi?",
      options: ["Nakit", "Kartla", "Çekle", "Havale ile"],
      correctAnswer: "Kartla",
    },
    {
      id: 8,
      question: "'Cette chemise' cümlesinde neden 'cette' kullanıldı?",
  ...
  vocabulary: [
    ...
    { word: "Un cadeau", meaning: "Hediye" },
    { word: "L'anniversaire", meaning: "Doğum günü" },
    { word: "La vendeuse", meaning: "Satıcı (kadın)" },
    { word: "Montrer", meaning: "Göstermek" },
    { word: "Choisir", meaning: "Seçmek" },
  ],
};

const unit343Reading: UnitReading = {
  unitId: 343,
  title: "Cumartesi Temizliği",
  language: "Fransızca",
  level: "A2",
  story: {
  ...
  questions: [
    {
      id: 1,
      question: "Hugo az önce ne yaptı?",
      options: ["Bulaşık yıkadı", "Süpürge çekti", "Çamaşır yıkadı", "Ütü yaptı"],
      correctAnswer: "Süpürge çekti",
    },
    {
      id: 2,
      question: "Lucas az önce ne yaptı?",
      options: ["Süpürge çekti", "Bulaşık yıkadı", "Yatağı topladı", "Ütü yaptı"],
      correctAnswer: "Bulaşık yıkadı",
    },
    {
      id: 3,
      question: "Hugo, Lucas'a ne yapmasını söyledi?",
      options: ["Bulaşık yıkama", "Çamaşır yıkama", "Süpürge çekme", "Ütü yapma"],
      correctAnswer: "Çamaşır yıkama",
    },
    {
      id: 4,
      question: "Lucas neden itiraz etti?",
      options: [
        "Yorgundu",
        "Az önce bulaşıkları yıkamıştı",
        "Hasta oldu",
        "Dışarı çıkmak istiyordu",
      ],
      correctAnswer: "Az önce bulaşıkları yıkamıştı",
    },
    {
      id: 5,
      question: "Sonunda çamaşırı kim yıkadı?",
      options: ["Lucas", "Hugo", "İkisi birlikte", "Hiçbiri"],
      correctAnswer: "Hugo",
    },
    {
      id: 6,
      question: "Lucas hangi ek işi yaptı?",
      options: ["Banyoyu temizledi", "Gömlekleri ütüledi", "Yemek yaptı", "Araba yıkadı"],
      correctAnswer: "Gömlekleri ütüledi",
    },
    {
      id: 7,
      question: "Öğle vakti ev nasıldı?",
      options: ["Dağınıktı", "Tertemizdi", "Karanlıktı", "Soğuktu"],
      correctAnswer: "Tertemizdi",
    },
    {
      id: 8,
      question: "Hugo sonunda ne yapmak istedi?",
  ...
  vocabulary: [
    ...
    { word: "Répondre", meaning: "Cevap vermek" },
    { word: "Finalement", meaning: "Sonunda" },
    { word: "Propre", meaning: "Temiz" },
    { word: "Fatigué", meaning: "Yorgun" },
    { word: "Se reposer", meaning: "Dinlenmek" },
  ],
};

const unit344Reading: UnitReading = {
  unitId: 344,
  title: "Fırtına Haberi",
  language: "Fransızca",
  level: "A2",
  story: {
  ...
  questions: [
    {
      id: 1,
      question: "Marc'ın mesleği ne?",
      options: ["Öğretmen", "Doktor", "Gazeteci", "Polis"],
      correctAnswer: "Gazeteci",
    },
    {
      id: 2,
      question: "Hava durumu nasıldı?",
      options: ["Güzeldi", "Berbattı", "Sıcaktı", "Karlıydı"],
      correctAnswer: "Berbattı",
    },
    {
      id: 3,
      question: "İnsanlar haberleri nerede izliyorlardı?",
      options: ["Kafede", "Okulda", "Evlerinde", "Parkta"],
      correctAnswer: "Evlerinde",
    },
    {
      id: 4,
      question: "Kadın çocukken fırtınalar hakkında ne dedi?",
      options: [
        "Fırtınalar çok güçlüydü",
        "Böyle fırtınalar yoktu",
        "Hep fırtına vardı",
        "Fırtınalardan korkardı",
      ],
      correctAnswer: "Böyle fırtınalar yoktu",
    },
    {
      id: 5,
      question: "Adam ne yapıyordu?",
      options: [
        "TV izliyordu",
        "Uyuyordu",
        "Gazete okuyor ve radyo dinliyordu",
        "Yemek yapıyordu",
      ],
      correctAnswer: "Gazete okuyor ve radyo dinliyordu",
    },
    {
      id: 6,
      question: "Marc programın sonunda ne söyledi?",
      options: [
        "Hava güzelleşecek",
        "Evinizde kalın",
        "Dışarı çıkın",
      ...
      correctAnswer: "Evinizde kalın",
    },
    {
      id: 7,
      question: "'Il y avait beaucoup de vent' cümlesinde hangi zaman kullanılmış?",
      options: ["Présent", "Passé Composé", "Imparfait", "Futur"],
      correctAnswer: "Imparfait",
    },
    {
      id: 8,
      question: "Herkes ne bekliyordu?",
  ...
  vocabulary: [
    ...
    { word: "Il pleuvait", meaning: "Yağmur yağıyordu" },
    { word: "Inquiet(s)", meaning: "Endişeli" },
    { word: "Les habitants", meaning: "Sakinler / Oturanlar" },
    { word: "Attendait", meaning: "Bekliyordu" },
    { word: "Il y avait", meaning: "Vardı" },
  ],
};

const unit345Reading: UnitReading = {
  unitId: 345,
  title: "Televizyon Akşamı",
  language: "Fransızca",
  level: "A2",
  story: {
  ...
  questions: [
    {
      id: 1,
      question: "Antoine'ın en sevdiği program saat kaçta başlıyor?",
      options: ["19:00", "20:00", "21:00", "22:00"],
      correctAnswer: "20:00",
    },
    {
      id: 2,
      question: "Sophie sunucu hakkında ne düşünüyor?",
      options: ["Çok eğlenceli", "Çok konuşuyor", "Çok sessiz", "Çok yakışıklı"],
      correctAnswer: "Çok konuşuyor",
    },
    {
      id: 3,
      question: "Hangi konu hakkında bir belgesel izlemeye karar veriyorlar?",
      options: ["Tarih", "Uzay", "Doğa", "Spor"],
      correctAnswer: "Doğa",
    },
    {
      id: 4,
      question: "Reklam sırasında Antoine ne yapıyor?",
      options: [
      ...
      correctAnswer: "Kanal değiştiriyor",
    },
    {
      id: 5,
      question: "Reklam bitene kadar ne izliyorlar?",
      options: ["Müzik", "Dizi", "Belgesel", "Haberler"],
      correctAnswer: "Haberler",
    },
    {
      id: 6,
      question: "Sophie belgesel hakkında ne hissediyor?",
      options: ["Nefret ediyor", "Sıkıcı buluyor", "Bayılıyor", "Korkutucu buluyor"],
      correctAnswer: "Bayılıyor",
    },
    {
      id: 7,
      question: "İkisi televizyon izlerken her zaman aynı fikirde mi?",
      options: ["Evet, her zaman", "Hayır, ara sıra anlaşamıyorlar", "Hiç birlikte izlemiyorlar", "Sadece belgesellerde anlaşıyorlar"],
      correctAnswer: "Hayır, ara sıra anlaşamıyorlar",
    },
    {
      id: 8,
      question: "Antoine ve Sophie'nin ortak sevmediği şey nedir?",
  ...
  vocabulary: [
    ...
    { word: "L'émission", meaning: "TV Programı" },
    { word: "Le présentateur", meaning: "Sunucu" },
    { word: "La publicité", meaning: "Reklam" },
    { word: "Changer de chaîne", meaning: "Kanal değiştirmek" },
    { word: "Les informations", meaning: "Haberler" },
  ],
};

const unit346Reading: UnitReading = {
  unitId: 346,
  title: "Une Soirée au Cinéma (Bir Sinema Akşamı)",
  language: "Fransızca",
  level: "A2",
  story: {
  ...
  questions: [
    {
      id: 1,
      question: "Où sont-ils allés hier soir ?",
      options: ["Au théâtre", "Au cinéma", "Au concert", "A l'école"],
      correctAnswer: "Au cinéma",
    },
    {
      id: 2,
      question: "Quel genre de film ont-ils regardé en réalité ?",
      options: ["Une comédie", "Un dessin animé", "Un film d'action", "Un documentaire"],
      correctAnswer: "Un film d'action",
    },
    {
      id: 3,
      question: "Comment le narrateur décrit-il le film ?",
      options: ["Le plus court", "Le plus long et le plus excitant", "Le moins intéressant", "Le pire"],
      correctAnswer: "Le plus long et le plus excitant",
    },
    {
      id: 4,
      question: "Que pense le narrateur de l'acteur principal ?",
      options: ["C'est le pire acteur", "Il n'est pas célèbre", "C'est le réalisateur", "C'est le meilleur acteur du monde"],
      correctAnswer: "C'est le meilleur acteur du monde",
    },
    {
      id: 5,
      question: "Sophie pense que c'était quel genre de film ?",
      options: ["Un film d'horreur", "Un documentaire", "La meilleure comédie", "Le pire film d'action"],
      correctAnswer: "La meilleure comédie",
    },
    {
      id: 6,
      question: "Est-ce que le scénario était très original ?",
      options: ["Oui, le plus original", "Non, c'était le moins original", "C'était compliqué", "On ne sait pas"],
      correctAnswer: "Non, c'était le moins original",
    },
    {
      id: 7,
      question: "Comment était la musique du film ?",
      options: ["La moins belle", "La plus belle", "Terrible", "Forte"],
      correctAnswer: "La plus belle",
    },
    {
      id: 8,
      question: "Quelle est leur conclusion finale ?",
  ...
  vocabulary: [
    ...
    { word: "Un film d'action", meaning: "Aksiyon filmi" },
    { word: "Le meilleur", meaning: "En iyi" },
    { word: "Le plus long", meaning: "En uzun" },
    { word: "Le moins original", meaning: "En az orijinal" },
  ],
};

const unit347Reading: UnitReading = {
  unitId: 347,
  title: "Müzik Zevkleri ve Bir Konser Akşamı",
  language: "Fransızca",
  level: "A2",
  story: {
  ...
  questions: [
    {
      id: 1,
      question: "Léa quel genre de musique préfère-t-elle?",
      options: ["La musique classique", "Le rock", "Le jazz"],
      correctAnswer: "Le rock",
    },
    {
      id: 2,
      question: "Depuis quand Léa joue-t-elle du piano?",
      options: ["Depuis l'année 2022", "Depuis hier", "Depuis dix ans"],
      correctAnswer: "Depuis dix ans",
    },
    {
      id: 3,
      question: "Quel instrument a-t-elle commencé à apprendre l'année dernière?",
      options: ["La guitare", "La batterie", "Le piano"],
      correctAnswer: "La guitare",
    },
    {
      id: 4,
      question: "Avec qui est-elle allée au concert?",
      options: ["Avec ses parents", "Avec son ami Hugo", "Avec le chanteur"],
      correctAnswer: "Avec son ami Hugo",
    },
    {
      id: 5,
      question: "Depuis quelle année Léa et Hugo écoutent-ils ce groupe?",
      options: ["Depuis 2020", "Depuis 2022", "Depuis l'enfance"],
      correctAnswer: "Depuis 2022",
    },
    {
      id: 6,
      question: "Qui a une voix magnifique selon Léa?",
      options: ["Le batteur", "Le musicien", "Le chanteur"],
      correctAnswer: "Le chanteur",
    },
    {
      id: 7,
      question: "Qu'est-ce que le groupe a joué à la fin du concert?",
      options: ["Leur ancienne chanson", "Leur nouvel album", "De la musique classique"],
      correctAnswer: "Leur nouvel album",
    },
    {
      id: 8,
      question: "Que veut faire Léa maintenant?",
  ...
  vocabulary: [
    ...
    { word: "Le batteur", meaning: "Baterist" },
    { word: "Une voix", meaning: "Ses" },
    { word: "Former un groupe", meaning: "Grup kurmak" },
    { word: "Incroyable", meaning: "İnanılmaz" },
  ],
};

const unit348Reading: UnitReading = {
  unitId: 348,
  ...
  questions: [
    {
      id: 1,
      question: "Lucas hafta sonu ne oynuyor?",
      options: ["Basketbol", "Futbol", "Tenis", "Voleybol"],
      correctAnswer: "Futbol",
    },
    {
      id: 2,
      question: "Çarşamba günleri hangi sporu yapıyor?",
      options: ["Koşu", "Yüzme", "Jimnastik", "Bisiklet"],
      correctAnswer: "Yüzme",
    },
    {
      id: 3,
      question: "Lucas maçı ne yapmak istiyor?",
      options: ["İzlemek", "Kaybetmek", "Kazanmak", "Bırakmak"],
      correctAnswer: "Kazanmak",
    },
    {
      id: 4,
      question: "Cuma günleri bisiklete kiminle biniyor?",
  ...
  vocabulary: [
    ...
    { word: "Gagner le match", meaning: "Maçı kazanmak" },
    { word: "En très bonne forme", meaning: "Çok iyi formda" },
  ],
};
...
const unit349Reading: UnitReading = {
  ...
  level: "A2",
  story: {
    text: "Samedi matin, Lucas et sa cousine Léa décident d'aller à la forêt pour faire un pique-nique. Il fait très beau et le soleil brille.\\n\\nLucas: Tu as envie d'aller à la forêt aujourd'hui ? C'est un bel endroit pour se détendre.\\n\\nLéa: Bonne idée ! On y va en voiture ?\\n\\nLucas: Non, on y va à vélo, c'est plus sympa. As-tu préparé les sandwichs ?\\n\\nLéa: Oui, j'en ai préparé quatre au fromage. Et toi, tu as pris de l'eau ?\\n\\nLucas: Oui, j'en ai pris deux bouteilles. Je prends aussi des fruits.\\n\\nIls arrivent dans la nature, près d'une petite rivière. Le paysage est magnifique. Ils s'assoient sous un grand arbre et mangent leur repas. C'est un super pique-nique !",
    translation:
      "Cumartesi sabahı Lucas ve kuzeni Léa piknik yapmak için ormana gitmeye karar verirler. Hava çok güzeldir ve güneş parlamaktadır.\\n\\nLucas: Bugün ormana gitmek ister misin? Dinlenmek için güzel bir yer.\\n\\nLéa: İyi fikir! Oraya arabayla mı gidelim?\\n\\nLucas: Hayır, oraya bisikletle gidelim, daha keyifli. Sandviçleri hazırladın mı?\\n\\nLéa: Evet, onlardan dört tane peynirli hazırladım. Peki sen, su aldın mı?\\n\\nLucas: Evet, ondan iki şişe aldım. Meyve de alıyorum.\\n\\nDoğanın içine, küçük bir nehrin yakınına varırlar. Manzara muhteşemdir. Büyük bir ağacın altına oturup yemeklerini yerler. Bu harika bir pikniktir!",
  },
  questions: [
    {
      id: 1,
      question: "Nereye gidiyorlar?",
      options: ["Au cinéma", "À la mer", "À la forêt", "Au café"],
      correctAnswer: "À la forêt",
    },
    {
      id: 2,
      question: "Oraya nasıl gidiyorlar?",
      options: ["En bus", "En voiture", "À pied", "À vélo"],
      correctAnswer: "À vélo",
    },
    {
      id: 3,
      question: "Léa kaç tane sandviç hazırladı?",
      options: ["Deux", "Trois", "Quatre", "Cinq"],
      correctAnswer: "Quatre",
    },
    {
      id: 4,
      question: "Nereye oturuyorlar?",
      options: [
        "Sous un arbre",
        "Dans la voiture",
        "Sur un banc",
      ...
      correctAnswer: "Sous un arbre",
    },
    {
      id: 5,
      question:
        "Diyalogda 'On y va' cümlesindeki 'y' zamiri nereyi temsil ediyor?",
      options: ["La rivière", "La forêt", "La voiture", "Le vélo"],
      correctAnswer: "La forêt",
    },
  ],
  vocabulary: [
    { word: "La forêt", meaning: "Orman" },
    { word: "Le paysage", meaning: "Manzara" },
...
const unit351Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Belgeler gönderildi",
    },
    {
      id: 5,
      question: "Bay Martin ne istiyor?",
      options: ["Geri aranmak", "Randevu almak", "Ofise gelmek", "Beklemek"],
      correctAnswer: "Geri aranmak",
    },
  ],
  vocabulary: [
...
const unit352Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Cumartesi akşamı",
    },
    {
      id: 3,
      question: "Konser saat kaçta başlıyor?",
      options: ["18:00", "19:00", "20:00", "21:00"],
      correctAnswer: "20:00",
    },
    {
      id: 4,
      question: "Marie'nin cevabı ne?",
      options: ["Hayır", "Belki", "Memnuniyetle", "Bilmiyorum"],
      correctAnswer: "Memnuniyetle",
    },
    {
      id: 5,
      question: "Nerede buluşacaklar?",
      options: ["Evde", "Kafede", "Metroda", "Konser salonu önünde"],
      correctAnswer: "Konser salonu önünde",
    },
  ],
  vocabulary: [
...
const unit353Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Metro ile gelecek",
    },
    {
      id: 4,
      question: "Patron ne istedi?",
      options: [
        "İstifa etsin",
        "Para cezası",
        "Sorun olursa araması",
        "Eve gitmesi",
      ],
      correctAnswer: "Sorun olursa araması",
    },
    {
      id: 5,
      question: "Patronun tepkisi nasıldı?",
      options: ["Çok kızgın", "Affetti", "Kovdu", "Umursamadı"],
      correctAnswer: "Affetti",
    },
  ],
  vocabulary: [
...
const unit355Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Cami ve Ayasofya",
    },
    {
      id: 4,
      question: "Kapalıçarşı nerede?",
      options: [
        "Merkezden uzakta",
        "Caminin yanında",
        "Deniz kenarında",
      ...
      correctAnswer: "Caminin yanında",
    },
    {
      id: 5,
      question: "İstanbul neyle ünlü?",
      options: ["Plajları", "Dağları", "Tarihi ve mutfağı", "Fabrikaları"],
      correctAnswer: "Tarihi ve mutfağı",
    },
  ],
  vocabulary: [
...
const unit356Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "El sıkışarak",
    },
    {
      id: 5,
      question: "Mehmet şimdi ne düşünüyor?",
      options: ["Hala garip buluyor", "Normal buluyor", "Sevmiyor", "Yapmıyor"],
      correctAnswer: "Normal buluyor",
    },
  ],
  vocabulary: [
...
const unit357Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: "Çok hata yapıyor",
    },
    {
      id: 4,
      question: "Léo ne teklif etti?",
      options: [
        "Film izlemek",
        "Birlikte çalışmak",
        "Yemek yemek",
      ...
      correctAnswer: "Birlikte çalışmak",
    },
    {
      id: 5,
      question: "Léa sınavdan kaç aldı?",
...
const unit358Reading: UnitReading = {
  ...
  story: {
    ...
    translation:
      "Thomas üç aydır iş arıyor. Çok CV ve motivasyon mektubu gönderdi. Geçen hafta büyük bir şirkette mülakata girdi.\\n\\nDirektör ona sordu: 'Neden bizimle çalışmak istiyorsunuz?' Thomas cevapladı: 'Çok motive biriyim ve bu alanda deneyimim var.'\\n\\nİki gün sonra şirket onu geri aradı. Sekreter dedi ki: 'Tebrikler, işe alındınız! Pazartesi sözleşmeyi imzalamalısınız. Maaşınız ayda 2500 euro olacak.'\\n\\nThomas çok mutluydu. İyi haberi vermek için ailesini aradı. İlk iş gününde yeni iş arkadaşlarıyla tanıştı. Şefi sorumluluklarını anlattı ve dedi ki: 'Ekibe hoş geldin!'",
  },
  questions: [
    {
      id: 1,
      question: "Thomas ne kadar zamandır iş arıyordu?",
      options: ["Bir hafta", "Bir ay", "Üç ay", "Altı ay"],
      correctAnswer: "Üç ay",
    },
    {
      id: 2,
      question: "Thomas mülakatta ne soruldu?",
      options: [
        "Ne kadar kazanmak istiyor",
        "Neden orada çalışmak istiyor",
        "Ne zaman başlayabilir",
        "Nerede yaşıyor",
      ],
      correctAnswer: "Neden orada çalışmak istiyor",
    },
    {
      id: 3,
      question: "Thomas işe alındı mı?",
      options: ["Evet", "Hayır", "Bekliyorlar", "Bilmiyoruz"],
      correctAnswer: "Evet",
    },
    {
      id: 4,
      question: "Thomas'ın maaşı ne kadar?",
      options: ["1500 euro", "2000 euro", "2500 euro", "3000 euro"],
      correctAnswer: "2500 euro",
    },
    {
      id: 5,
      question: "Thomas iyi haberi kime verdi?",
      options: ["Arkadaşlarına", "Ailesine", "Komşularına", "Öğretmenine"],
      correctAnswer: "Ailesine",
    },
  ],
  vocabulary: [
...
const unit359Reading: UnitReading = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        "L'écran était noir",
        "Internet ne marchait pas",
        "La souris était cassée",
        "Le clavier ne fonctionnait pas",
      ],
      correctAnswer: "Internet ne marchait pas",
    },
    {
      id: 3,
      question: "Qu'est-ce qu'Ali a essayé de faire?",
      options: [
        "Télécharger internet",
        "Changer le mot de passe",
        "Éteindre et rallumer l'ordinateur",
        "Acheter un nouveau laptop",
      ],
      correctAnswer: "Éteindre et rallumer l'ordinateur",
    },
    {
      id: 4,
      question: "Qui a résolu le problème?",
      options: ["Ali", "Paul", "Le technicien", "Le directeur"],
      correctAnswer: "Le technicien",
    },
    {
      id: 5,
      question: "Qu'est-ce que le technicien a conseillé?",
      options: [
        "Acheter un nouvel ordinateur",
        "Sauvegarder les fichiers régulièrement",
        "Éteindre le wifi",
        "Partir en vacances",
      ],
      correctAnswer: "Sauvegarder les fichiers régulièrement",
    },
  ],
  vocabulary: [
...
const unit360Reading: UnitReading = {
  unitId: 360,
  title: "A2 Final",
  language: "Fransızca",
  level: "A2",
...
export function getFrenchA2ReadingForUnit(
  unitId: number,
): UnitReading | undefined {
