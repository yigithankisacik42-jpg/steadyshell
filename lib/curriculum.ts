...
const spanishB2Units: Unit[] = [
    ...
    { id: 111, title: "Çağdaş Edebiyat", description: "Modern İspanyol yazarlar", ...unitColors[10], lessons: generateLessons(1000) },
    { id: 112, title: "Eleştiri Yazarlığı", description: "Analitik yazım", ...unitColors[11], lessons: generateLessons(1010) },
    { id: 113, title: "Medya Analizi", description: "Haber ve propaganda", ...unitColors[12], lessons: generateLessons(1020) },
    { id: 114, title: "Sosyoloji ve Toplum", description: "Sosyal meseleler", ...unitColors[13], lessons: generateLessons(1030) },
    { id: 115, title: "Felsefe Temelleri", description: "Düşünce tarihi", ...unitColors[14], lessons: generateLessons(1040) },
    { id: 116, title: "Bilimsel Araştırma", description: "Araştırma metodolojisi", ...unitColors[15], lessons: generateLessons(1050) },
    { id: 117, title: "Çevre Politikaları", description: "Küresel çevre sorunları", ...unitColors[16], lessons: generateLessons(1060) },
    { id: 118, title: "Uluslararası İlişkiler", description: "Diplomasi dili", ...unitColors[17], lessons: generateLessons(1070) },
    { id: 119, title: "Kültürlerarası İletişim", description: "Farklı kültürler", ...unitColors[18], lessons: generateLessons(1080) },
    { id: 120, title: "B2 Final Tekrar", description: "Kapsamlı değerlendirme", ...unitColors[19], lessons: generateLessons(1090) },
];

// ===== İNGİLİZCE A1 (30 Ünite: ID 101-130) =====
const englishA1Units: Unit[] = [
    { id: 111, title: "Selamlaşma ve Tanışma", description: "Hello, how are you", ...unitColors[0], lessons: generateLessons(5000) },
    { id: 112, title: "Sayılar 1-20", description: "Basic numbers", ...unitColors[1], lessons: generateLessons(5020) },
    { id: 113, title: "Aile Üyeleri", description: "Family members", ...unitColors[2], lessons: generateLessons(5040) },
    { id: 114, title: "Renkler", description: "Colors", ...unitColors[3], lessons: generateLessons(5060) },
    { id: 115, title: "Yiyecekler", description: "Fruits and vegetables", ...unitColors[4], lessons: generateLessons(5080) },
    { id: 116, title: "İçecekler", description: "Water, coffee, tea", ...unitColors[5], lessons: generateLessons(5100) },
    { id: 117, title: "Günler ve Aylar", description: "Monday, January", ...unitColors[6], lessons: generateLessons(5120) },
    { id: 118, title: "Sayılar 21-100", description: "Advanced numbers", ...unitColors[7], lessons: generateLessons(5140) },
    { id: 119, title: "Ev Odaları", description: "Bedroom, kitchen", ...unitColors[8], lessons: generateLessons(5160) },
    { id: 120, title: "Mobilyalar", description: "Table, chair", ...unitColors[9], lessons: generateLessons(5180) },
    { id: 121, title: "Vücut Bölümleri", description: "Head, arm, leg", ...unitColors[10], lessons: generateLessons(5200) },
    { id: 122, title: "Giysiler", description: "Shirt, pants", ...unitColors[11], lessons: generateLessons(5220) },
    { id: 123, title: "Hayvanlar", description: "Cat, dog, bird", ...unitColors[12], lessons: generateLessons(5240) },
    { id: 124, title: "Meslekler 1", description: "Doctor, teacher", ...unitColors[13], lessons: generateLessons(5260) },
    { id: 125, title: "Şehirde Yerler", description: "School, market, park", ...unitColors[14], lessons: generateLessons(5280) },
    { id: 126, title: "Ulaşım Araçları", description: "Car, bus", ...unitColors[15], lessons: generateLessons(5300) },
    { id: 127, title: "Günlük Rutinler", description: "Wake up, eat", ...unitColors[16], lessons: generateLessons(5320) },
    { id: 128, title: "Saat Kaç?", description: "Telling time", ...unitColors[17], lessons: generateLessons(5340) },
    { id: 129, title: "Hava Durumu", description: "Sunny, rainy", ...unitColors[18], lessons: generateLessons(5360) },
    { id: 130, title: "Hobiler", description: "Sports, music", ...unitColors[19], lessons: generateLessons(5380) },
    // YENİ ÜNİTELER (21-30)
    { id: 131, title: "Duygular ve Hisler", description: "Happy, sad, angry", ...unitColors[0], lessons: generateLessons(5400) },
    { id: 132, title: "Okul ve Sınıf", description: "Book, pen, classroom", ...unitColors[1], lessons: generateLessons(5420) },
    { id: 133, title: "Tatiller ve Bayramlar", description: "Christmas, birthday", ...unitColors[2], lessons: generateLessons(5440) },
    { id: 134, title: "Ülkeler ve Milletler", description: "Countries, nationalities", ...unitColors[3], lessons: generateLessons(5460) },
    { id: 135, title: "Temel Fiiller", description: "Go, come, do, make", ...unitColors[4], lessons: generateLessons(5480) },
    { id: 136, title: "Present Simple", description: "I work, she works", ...unitColors[5], lessons: generateLessons(5500) },
    { id: 137, title: "Present Continuous", description: "I am working", ...unitColors[6], lessons: generateLessons(5520) },
    { id: 138, title: "Sıfatlar", description: "Big, small, beautiful", ...unitColors[7], lessons: generateLessons(5540) },
    { id: 139, title: "Edatlar", description: "In, on, at, under", ...unitColors[8], lessons: generateLessons(5560) },
    { id: 140, title: "A1 Tekrar", description: "A1 level review", ...unitColors[9], lessons: generateLessons(5580) },
];


// ===== İNGİLİZCE A2 (30 Ünite: ID 131-160) =====
const englishA2Units: Unit[] = [
    { id: 141, title: "Geçmiş Zaman 1", description: "Simple past", ...unitColors[0], lessons: generateLessons(6000) },
    { id: 142, title: "Geçmiş Zaman 2", description: "Irregular verbs", ...unitColors[1], lessons: generateLessons(6020) },
    { id: 143, title: "Restoranda", description: "Ordering food", ...unitColors[2], lessons: generateLessons(6040) },
    { id: 144, title: "Alışveriş", description: "Asking prices", ...unitColors[3], lessons: generateLessons(6060) },
    { id: 145, title: "Seyahat Planları", description: "Vacation places", ...unitColors[4], lessons: generateLessons(6080) },
    { id: 146, title: "Otel Rezervasyonu", description: "Booking a room", ...unitColors[5], lessons: generateLessons(6100) },
    { id: 147, title: "Havalimanında", description: "Flight information", ...unitColors[6], lessons: generateLessons(6120) },
    { id: 148, title: "Doktorda", description: "Describing symptoms", ...unitColors[7], lessons: generateLessons(6140) },
    { id: 149, title: "Eczanede", description: "Getting medicine", ...unitColors[8], lessons: generateLessons(6160) },
    { id: 150, title: "Meslekler 2", description: "Job descriptions", ...unitColors[9], lessons: generateLessons(6180) },
    { id: 151, title: "İş Görüşmesi", description: "CV preparation", ...unitColors[10], lessons: generateLessons(6200) },
    { id: 152, title: "Telefonda", description: "Phone conversation", ...unitColors[11], lessons: generateLessons(6220) },
    { id: 153, title: "E-posta Yazma", description: "Formal writing", ...unitColors[12], lessons: generateLessons(6240) },
    { id: 154, title: "Duygular", description: "Happy, sad", ...unitColors[13], lessons: generateLessons(6260) },
    { id: 155, title: "Karakter Özellikleri", description: "Kind, hardworking", ...unitColors[14], lessons: generateLessons(6280) },
    { id: 156, title: "Spor ve Fitness", description: "Exercise types", ...unitColors[15], lessons: generateLessons(6300) },
    { id: 157, title: "Müzik ve Sanat", description: "Instruments", ...unitColors[16], lessons: generateLessons(6320) },
    { id: 158, title: "Sinema ve Dizi", description: "Movie genres", ...unitColors[17], lessons: generateLessons(6340) },
    { id: 159, title: "Teknoloji", description: "Computer, phone", ...unitColors[18], lessons: generateLessons(6360) },
    { id: 160, title: "Sosyal Medya", description: "Internet use", ...unitColors[19], lessons: generateLessons(6380) },
    // YENİ ÜNİTELER (21-30)
    { id: 161, title: "Ev ve Taşınma", description: "Renting, moving", ...unitColors[0], lessons: generateLessons(6400) },
    { id: 162, title: "Çevre ve Doğa", description: "Environment", ...unitColors[1], lessons: generateLessons(6420) },
    { id: 163, title: "Haberler", description: "News, media", ...unitColors[2], lessons: generateLessons(6440) },
    { id: 164, title: "Kültür ve Gelenekler", description: "Culture, traditions", ...unitColors[3], lessons: generateLessons(6460) },
    { id: 165, title: "Present Perfect", description: "Have done", ...unitColors[4], lessons: generateLessons(6480) },
    { id: 166, title: "Comparatives", description: "Bigger, smaller", ...unitColors[5], lessons: generateLessons(6500) },
    { id: 167, title: "Superlatives", description: "The biggest", ...unitColors[6], lessons: generateLessons(6520) },
    { id: 168, title: "Modal Verbs", description: "Can, must, should", ...unitColors[7], lessons: generateLessons(6540) },
    { id: 169, title: "Question Tags", description: "Isn't it?", ...unitColors[8], lessons: generateLessons(6560) },
    { id: 170, title: "A2 Tekrar", description: "A2 level review", ...unitColors[9], lessons: generateLessons(6580) },
];

// ===== İNGİLİZCE B1 (30 Ünite: ID 161-190) =====
const englishB1Units: Unit[] = [
    { id: 171, title: "Gelecek Zaman", description: "Will and going to", ...unitColors[0], lessons: generateLessons(7000) },
    { id: 172, title: "Koşul Cümleleri 1", description: "First conditional", ...unitColors[1], lessons: generateLessons(7020) },
    { id: 173, title: "Koşul Cümleleri 2", description: "Second conditional", ...unitColors[2], lessons: generateLessons(7040) },
    { id: 174, title: "Passive Voice", description: "Edilgen yapı", ...unitColors[3], lessons: generateLessons(7060) },
    { id: 175, title: "Reported Speech", description: "Dolaylı anlatım", ...unitColors[4], lessons: generateLessons(7080) },
    { id: 176, title: "Phrasal Verbs 1", description: "Deyimsel fiiller", ...unitColors[5], lessons: generateLessons(7100) },
    { id: 177, title: "Phrasal Verbs 2", description: "Daha fazla deyim", ...unitColors[6], lessons: generateLessons(7120) },
    { id: 178, title: "Haberler ve Medya", description: "News reading", ...unitColors[7], lessons: generateLessons(7140) },
    { id: 179, title: "Çevre Sorunları", description: "Environment", ...unitColors[8], lessons: generateLessons(7160) },
    { id: 180, title: "Sürdürülebilirlik", description: "Recycling", ...unitColors[9], lessons: generateLessons(7180) },
    { id: 181, title: "Kültür ve Gelenekler", description: "Festivals", ...unitColors[10], lessons: generateLessons(7200) },
    { id: 182, title: "Ekonomi Temelleri", description: "Money, budget", ...unitColors[11], lessons: generateLessons(7220) },
    { id: 183, title: "Tartışma Becerileri", description: "Giving opinions", ...unitColors[12], lessons: generateLessons(7240) },
    { id: 184, title: "Sunum Yapma", description: "Presentations", ...unitColors[13], lessons: generateLessons(7260) },
    { id: 185, title: "Edebiyat 1", description: "Story reading", ...unitColors[14], lessons: generateLessons(7280) },
    { id: 186, title: "Akademik Yazma", description: "Essay writing", ...unitColors[15], lessons: generateLessons(7300) },
    { id: 187, title: "Bilim ve Teknoloji", description: "Innovations", ...unitColors[16], lessons: generateLessons(7320) },
    { id: 188, title: "Sağlık ve Beslenme", description: "Healthy living", ...unitColors[17], lessons: generateLessons(7340) },
    { id: 189, title: "Psikoloji Temelleri", description: "Behavior, thoughts", ...unitColors[18], lessons: generateLessons(7360) },
    { id: 190, title: "İş İngilizcesi 1", description: "Business basics", ...unitColors[19], lessons: generateLessons(7380) },
    // YENİ ÜNİTELER (21-30)
    { id: 191, title: "Past Perfect", description: "Had done", ...unitColors[0], lessons: generateLessons(7400) },
    { id: 192, title: "Future Perfect", description: "Will have done", ...unitColors[1], lessons: generateLessons(7420) },
    { id: 193, title: "Relative Clauses", description: "Who, which, that", ...unitColors[2], lessons: generateLessons(7440) },
    { id: 194, title: "Causatives", description: "Have something done", ...unitColors[3], lessons: generateLessons(7460) },
    { id: 195, title: "Wish Clauses", description: "I wish I could", ...unitColors[4], lessons: generateLessons(7480) },
    { id: 196, title: "Collocations", description: "Word combinations", ...unitColors[5], lessons: generateLessons(7500) },
    { id: 197, title: "Connectors", description: "However, although", ...unitColors[6], lessons: generateLessons(7520) },
    { id: 198, title: "Formal vs Informal", description: "Register differences", ...unitColors[7], lessons: generateLessons(7540) },
    { id: 199, title: "Debate Skills", description: "Arguing points", ...unitColors[8], lessons: generateLessons(7560) },
    { id: 200, title: "B1 Tekrar", description: "B1 level review", ...unitColors[9], lessons: generateLessons(7580) },
];

// ===== İNGİLİZCE B2 (30 Ünite: ID 191-220) =====
const englishB2Units: Unit[] = [
    { id: 201, title: "İleri Gramer 1", description: "Advanced tenses", ...unitColors[0], lessons: generateLessons(8000) },
    { id: 202, title: "İleri Gramer 2", description: "Complex structures", ...unitColors[1], lessons: generateLessons(8020) },
    { id: 203, title: "Deyimler 1", description: "Common idioms", ...unitColors[2], lessons: generateLessons(8040) },
    { id: 204, title: "Deyimler 2", description: "More idioms", ...unitColors[3], lessons: generateLessons(8060) },
    { id: 205, title: "Formal Yazışma", description: "Formal letters", ...unitColors[4], lessons: generateLessons(8080) },
    { id: 206, title: "Sunum Teknikleri", description: "Advanced presenting", ...unitColors[5], lessons: generateLessons(8100) },
    { id: 207, title: "Müzakere", description: "Negotiation skills", ...unitColors[6], lessons: generateLessons(8120) },
    { id: 208, title: "Hukuk İngilizcesi", description: "Legal vocabulary", ...unitColors[7], lessons: generateLessons(8140) },
    { id: 209, title: "Tıbbi İngilizce", description: "Medical terms", ...unitColors[8], lessons: generateLessons(8160) },
    { id: 210, title: "Finans İngilizcesi", description: "Finance vocabulary", ...unitColors[9], lessons: generateLessons(8180) },
    { id: 211, title: "Edebiyat Analizi", description: "Literature analysis", ...unitColors[10], lessons: generateLessons(8200) },
    { id: 212, title: "Tartışmalı Konular", description: "Controversial topics", ...unitColors[11], lessons: generateLessons(8220) },
    { id: 213, title: "Akademik Okuma", description: "Research papers", ...unitColors[12], lessons: generateLessons(8240) },
    { id: 214, title: "Eleştirel Düşünme", description: "Critical thinking", ...unitColors[13], lessons: generateLessons(8260) },
    { id: 215, title: "Uluslararası İlişkiler", description: "Global affairs", ...unitColors[14], lessons: generateLessons(8280) },
    { id: 216, title: "Medya Analizi", description: "Media literacy", ...unitColors[15], lessons: generateLessons(8300) },
    { id: 217, title: "İş İngilizcesi 2", description: "Advanced business", ...unitColors[16], lessons: generateLessons(8320) },
    { id: 218, title: "Proje Yönetimi", description: "Project management", ...unitColors[17], lessons: generateLessons(8340) },
    { id: 219, title: "Kültürlerarası İletişim", description: "Cross-cultural", ...unitColors[18], lessons: generateLessons(8360) },
    { id: 220, title: "Kariyer Geliştirme", description: "Career development", ...unitColors[19], lessons: generateLessons(8380) },
    // YENİ ÜNİTELER (21-30)
    { id: 221, title: "Inversion", description: "Not only, hardly", ...unitColors[0], lessons: generateLessons(8400) },
    { id: 222, title: "Mixed Conditionals", description: "Complex conditions", ...unitColors[1], lessons: generateLessons(8420) },
    { id: 223, title: "Advanced Passive", description: "Complex passive forms", ...unitColors[2], lessons: generateLessons(8440) },
    { id: 224, title: "Cleft Sentences", description: "It is... that", ...unitColors[3], lessons: generateLessons(8460) },
    { id: 225, title: "Advanced Vocabulary", description: "C1 level words", ...unitColors[4], lessons: generateLessons(8480) },
    { id: 226, title: "Essay Writing", description: "Academic essays", ...unitColors[5], lessons: generateLessons(8500) },
    { id: 227, title: "Speaking Fluency", description: "Advanced speaking", ...unitColors[6], lessons: generateLessons(8520) },
    { id: 228, title: "Listening Skills", description: "Native speed", ...unitColors[7], lessons: generateLessons(8540) },
    { id: 229, title: "Reading Comprehension", description: "Complex texts", ...unitColors[8], lessons: generateLessons(8560) },
    { id: 230, title: "B2 Tekrar", description: "B2 level review", ...unitColors[9], lessons: generateLessons(8580) },
];
