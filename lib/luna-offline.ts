...
const GRAMMAR_CARDS: Record<SupportedLang, GrammarCard[]> = {
    es: [
        ...
        { topic: "Presente Continuo", keywords: ["continuo", "gerundio", "-ando", "-iendo", "şu an"], explanation: "📝 **Presente Continuo (Şimdiki Zaman)**\n\nEstar (çekimli) + Gerundio\n• -AR → -ando (hablando)\n• -ER/-IR → -iendo (comiendo, viviendo)\n\nEstoy **hablando** (konuşuyorum)", examples: ["Estoy **comiendo** (yiyorum) ahora", "¿Qué **estás haciendo** (ne yapıyorsun)?"] },
        { topic: "Futuro Simple", keywords: ["futuro", "gelecek", "mañana", "tomorrow"], explanation: "📝 **Futuro Simple (Basit Gelecek)**\n\nFiil + gelecek zaman eki:\n• yo hablar**é**\n• tú hablar**ás**\n• él hablar**á**\n\nKullanım: Gelecek planlar ve tahminler", examples: ["Mañana **viajaré** (seyahat edeceğim) a Madrid", "**Estudiarás** (çalışacaksın) mucho"] },
        { topic: "Por vs Para", keywords: ["por", "para", "için", "nedeniyle"], explanation: "📝 **Por vs Para**\n\n**Para**: Amaç, hedef, son tarih\n→ 'Para mí' (benim için), 'Para mañana' (yarın için)\n\n**Por**: Neden, süre, karşılık\n→ 'Por eso' (bu yüzden), 'Por la mañana' (sabahleyin)", examples: ["Esto es **para** (için) ti", "Gracias **por** (nedeniyle) tu ayuda"] },
        { topic: "Imperativo", keywords: ["imperativo", "emir", "command", "hazırla", "yap"], explanation: "📝 **Imperativo (Emir Kipi)**\n\nTú formu (düzenli):\n• -AR → habla\n• -ER → come\n• -IR → escribe\n\nOlumsuz: No + subjuntivo\n'¡No **hables** así!' (Böyle konuşma!)", examples: ["¡**Habla** (konuş) más despacio!", "¡**Come** (ye) tu sopa!"] },
    ],
    en: [
        ...
        { topic: "Present Continuous", keywords: ["present continuous", "progressive", "-ing", "now", "şu an"], explanation: "📝 **Present Continuous**\n\nBe (çekimli) + V-ing\n\n• I **am playing** (oynuyorum)\n• She **is reading** (okuyor)\n\nKullanım: Şu anda olan eylemler", examples: ["I **am studying** (çalışıyorum) English now", "They **are playing** (oynuyorlar) in the park"] },
        { topic: "Modal Verbs", keywords: ["modal", "can", "could", "should", "must", "may", "might"], explanation: "📝 **Modal Verbs**\n\n• **can**: yapabilmek\n• **should**: yapmalı\n• **must**: zorunda olmak\n• **may/might**: olabilir\n\nModal + yalın fiil (to yok!)\nI **can swim** ✅ I **can to swim** ❌", examples: ["You **should** (yapmalısın) study more", "I **can't** (yapamam) come today"] },
        { topic: "Passive Voice", keywords: ["passive", "edilgen", "was", "were", "been", "by"], explanation: "📝 **Passive Voice (Edilgen Çatı)**\n\nBe + Past Participle (V3)\n\n• Active: The cat **ate** the fish\n• Passive: The fish **was eaten** by the cat\n\nKullanım: Eylemi yapan önemli değilse", examples: ["The book **was written** (yazıldı) by Orhan Pamuk", "English **is spoken** (konuşulur) worldwide"] },
        { topic: "Reported Speech", keywords: ["reported", "indirect", "said", "told", "dolaylı"], explanation: "📝 **Reported Speech (Dolaylı Anlatım)**\n\nZaman bir geriye kayar:\n• 'I am tired' → She said she **was** tired\n• 'I will come' → He said he **would** come\n\nsay → said, tell → told", examples: ["He said he **was** (olduğunu) happy", "She told me she **would come** (geleceğini)"] },
    ],
    fr: [
...
const VOCAB_POOLS: Record<SupportedLang, VocabEntry[]> = {
    es: [
        ...
        { word: "equipaje", translation: "bagaj", example: "¿Dónde está mi **equipaje** (bagaj)?" },
        { word: "propina", translation: "bahşiş", example: "¿Debo dejar **propina** (bahşiş)?" },
        { word: "pedir", translation: "sipariş vermek/istemek", example: "Quiero **pedir** (sipariş vermek) una pizza." },
        { word: "recomendar", translation: "tavsiye etmek", example: "¿Qué me **recomienda** (tavsiye edersiniz)?" },
        { word: "cambio", translation: "bozuk para/değişim", example: "¿Tiene **cambio** (bozuk para)?" },
        { word: "reserva", translation: "rezervasyon", example: "Tengo una **reserva** (rezervasyon) a nombre de..." },
    ],
    en: [
        ...
        { word: "deadline", translation: "son tarih", example: "The **deadline** (son tarih) is tomorrow." },
        { word: "schedule", translation: "program/takvim", example: "Check your **schedule** (programını kontrol et)." },
        { word: "passenger", translation: "yolcu", example: "The **passenger** (yolcu) is waiting at the gate." },
        { word: "furniture", translation: "mobilya", example: "We need new **furniture** (mobilya) for the office." },
        { word: "improve", translation: "geliştirmek", example: "I want to **improve** (geliştirmek) my English." },
        { word: "opportunity", translation: "fırsat", example: "This is a great **opportunity** (fırsat)!" },
    ],
    fr: [
